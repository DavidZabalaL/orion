...
export function UsuarioRow({
  ...
  return (
    <>
      <tr style={{ borderBottom: modo === "ver" ? "1px solid var(--field-border)" : "none" }}>
      ...
      {errorEliminar && (
        <tr style={{ borderBottom: "1px solid var(--field-border)" }}>
          <td colSpan={6} className="px-4 py-3" style={{ background: "var(--status-escena-bg)" }}>
            <div className="flex items-start gap-2">
              ...
              <button onClick={() => setErrorEliminar(null)} className="ml-auto rounded-md px-2 py-0.5" style={{ fontFamily: "var(--font-ui)", fontSize: "var(--text-xs)", color: "var(--color-status-escena)" }}>
                Cerrar
              </button>
            </div>
          </td>
        ...
        <tr style={{ borderBottom: "1px solid var(--field-border)" }}>
          <td colSpan={6} className="px-4 py-4" style={{ background: "var(--field-bg)" }}>
            <div className="flex flex-wrap items-center gap-3">
              <TriangleAlert size={16} color="var(--color-status-escena)" className="shrink-0" />
              ...
              <form action={handleEliminar} className="flex items-center gap-2 ml-auto">
                <input type="hidden" name="id" value={u.id} />
                <button
                  type="submit"
                  disabled={pending}
          ...
          <td colSpan={6} className="px-4 py-4" style={{ background: "var(--field-bg)" }}>
            ...
            >
              ...
              <div className="flex-1 min-w-[220px]">
                <label className="block mb-1" style={{ fontFamily: "var(--font-ui)", fontSize: "var(--text-xs)", fontWeight: 600, color: "var(--sidebar-text)", textTransform: "uppercase" }}>Proyectos asignados</label>
