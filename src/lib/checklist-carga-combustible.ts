...
// Estados y municipios: catálogo completo de las 32 entidades de México
// (INEGI). Agrega tus áreas y personal reales en las secciones de abajo.
...
export const MUNICIPIOS_POR_ESTADO: Record<EstadoCarga, string[]> = {
  "AGUASCALIENTES": [
    "Aguascalientes",
    "Asientos",
    "Calvillo",
