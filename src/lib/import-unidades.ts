...
const MOTIVO_INDISPONIBILIDAD_ALIAS: Record<string, string> = {
  ...
  FALLA_MECANICA: "FALLA_MECANICA", "FALLA MECANICA": "FALLA_MECANICA", "FALLA MECÁNICA": "FALLA_MECANICA", "FALLAS MECANICAS": "FALLA_MECANICA", "FALLAS MECÁNICAS": "FALLA_MECANICA",
  OTRO: "OTRO",
};
